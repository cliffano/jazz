 ...
 * @returns {boolean} true when value exists in array
 */
...
/**
 * Parser converting scanner tokens into Jazz AST nodes.
 */
class Parser {
  /**
   * Create a parser.
   *
   * @param {Object} scanner: scanner instance providing next() tokens
   */
  constructor(scanner) {
   ...
   *
   * @returns {ast.AST} parsed AST root and globals
   */
  parse() {
    this.next();
