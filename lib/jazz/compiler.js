...
class CompileError extends Error {
   ...
   * @param {string} message: compile error details
   */
...
/**
 * Executable program generated from a Jazz template AST.
 */
class Program {
  /**
   * Create a program wrapper.
   *
   * @param {Function} fn: generated executable function
   * @param {Array<string>} globals: global variable names in call order
   */
   ...
   *
   * @param {Object} namespace: values referenced by template globals
   * @param {Function} cb: standard cb(result) callback
   * @returns {*} return value from generated function
   */
  eval(namespace, cb) {
   ...
   *
   * @param {Object} namespace: values keyed by global variable names
   * @returns {Array<*>} argument values in globals order
   */
...
class CompilerJS {
   ...
   *
   * @param {ast.AST} astRoot: parsed Jazz AST
   * @returns {Program} executable program instance
   */
  compile(astRoot) {
 ...
 *
 * @returns {CompilerJS} compiler instance
 */
